 ...
 * @brief       SoC processing task scaffold (no estimation algorithm yet).
 * @version     0.0.1
 * @date        2026-04-12
 */
...
namespace bms
{
    ...
    /**
     * @brief Row-by-row SoC processing placeholder task.
     */
    class SoCTask final
    {
    public:
        ...
        /**
         * @brief Placeholder hook for future SoC algorithm integration.
